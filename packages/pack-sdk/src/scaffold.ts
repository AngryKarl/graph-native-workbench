...
function sourceTemplate(id: string, title: string, standalone = false): string {
  return [
    ...(standalone ? [] : ["import { defineHandlers, definePack } from '@graphwork/pack-sdk';", '']),
    standalone ? 'export const pack = {' : 'export const pack = definePack({',
    `  id: '${id}',`,
    "  version: '0.1.0',",
    `  name: '${title} Pack',`,
    "  description: 'A minimal Industry Pack generated by Graphwork.',",
    "  license: 'MIT',",
    '  ontology: {',
    '    objectTypes: [{',
    "      id: 'artifact',",
...
export async function scaffoldPack(
  ...
  const packageJson = `${JSON.stringify(
    {
      ...
      ...(options.standalone ? {} : {
        dependencies: {
          '@graphwork/core': 'workspace:*',
          '@graphwork/pack-sdk': 'workspace:*',
        },
      }),
    },
    null,
  ...
  const readme = [
    `# ${title} Pack`,
    '',
    'Generated Industry Pack for Graphwork.',
    '',
