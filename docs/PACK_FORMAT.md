...
pnpm graph-workbench pack build packs/customer_success/src/index.ts \
  --output dist/customer_success-0.5.0.gpack
pnpm graph-workbench pack inspect dist/customer_success-0.5.0.gpack
```
...
```bash
pnpm graph-workbench pack install dist/customer_success-0.5.0.gpack --trust
...
```bash
pnpm graph-workbench pack activate customer_success@0.5.0
