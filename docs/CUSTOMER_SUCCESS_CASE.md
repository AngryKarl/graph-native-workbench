...
pnpm graph-workbench pack build packs/customer-success/src/index.ts \
  --output customer_success-0.6.0.gpack
pnpm graph-workbench pack inspect customer_success-0.6.0.gpack
pnpm graph-workbench pack install customer_success-0.6.0.gpack --trust
