...
pnpm graph-workbench pack build packs/customer-success/src/index.ts \
  --output customer_success-0.4.1.gpack
pnpm graph-workbench pack inspect customer_success-0.4.1.gpack
pnpm graph-workbench pack install customer_success-0.4.1.gpack --trust
